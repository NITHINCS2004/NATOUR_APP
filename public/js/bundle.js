    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          (0, _alerts.showAlert)('error', 'Error logging data try again.');
        case 3:
...
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"../../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var global = arguments[3];
/**
...
var displayMap = exports.displayMap = function displayMap(mapElement) {
  if (mapElement) {
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var sessionRes, session, options, razorpay, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
        ...
        case 1:
          sessionRes = _context.v;
          session = sessionRes.data.session; // 2. Create Razorpay payment object
          options = {
            key: 'rzp_test_ZI0RWBkCXGIpWe',
        ...
        case 2:
          ...
          _t = _context.v;
          console.error(_t);
          (0, _alerts.showAlert)('error', 'Payment failed. Please try again.');
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
...
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { if (r) i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n;else { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } o("next", 0), o("throw", 1), o("return", 2); } }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /*import { login, logout } from './login';
